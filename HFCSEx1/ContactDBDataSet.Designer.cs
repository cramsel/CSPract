...
namespace HFCSEx1 {
    ...
    public partial class ContactDBDataSet : global::System.Data.DataSet {
        ...
        public partial class PeopleDataTable : global::System.Data.TypedTableBase<PeopleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PeopleRow AddPeopleRow(int ContactID, string Name, string Company, string Phone, string Email, bool Client, System.DateTime LastCall) {
...
namespace HFCSEx1.ContactDBDataSetTableAdapters {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[People] WHERE (([ContactID] = @Original_ContactID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_LastCall = 1 AND [LastCall] IS NULL) OR ([LastCall] = @Original_LastCall)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[People] ([ContactID], [Name], [Company], [Phone], [Email], [Client], [LastCall]) VALUES (@ContactID, @Name, @Company, @Phone, @Email, @Client, @LastCall);
SELECT ContactID, Name, Company, Phone, Email, Client, LastCall FROM People WHERE (ContactID = @ContactID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[People] SET [ContactID] = @ContactID, [Name] = @Name, [Company] = @Company, [Phone] = @Phone, [Email] = @Email, [Client] = @Client, [LastCall] = @LastCall WHERE (([ContactID] = @Original_ContactID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_LastCall = 1 AND [LastCall] IS NULL) OR ([LastCall] = @Original_LastCall)));
SELECT ContactID, Name, Company, Phone, Email, Client, LastCall FROM People WHERE (ContactID = @ContactID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HFCSEx1.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactID, Name, Company, Phone, Email, Client, LastCall FROM dbo.People";
        ...
        public virtual int Delete(int Original_ContactID, string Original_Name, string Original_Company, string Original_Phone, string Original_Email, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_LastCall) {
        ...
        public virtual int Insert(int ContactID, string Name, string Company, string Phone, string Email, global::System.Nullable<bool> Client, global::System.Nullable<global::System.DateTime> LastCall) {
        ...
        public virtual int Update(int ContactID, string Name, string Company, string Phone, string Email, global::System.Nullable<bool> Client, global::System.Nullable<global::System.DateTime> LastCall, int Original_ContactID, string Original_Name, string Original_Company, string Original_Phone, string Original_Email, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_LastCall) {
        ...
        public virtual int Update(string Name, string Company, string Phone, string Email, global::System.Nullable<bool> Client, global::System.Nullable<global::System.DateTime> LastCall, int Original_ContactID, string Original_Name, string Original_Company, string Original_Phone, string Original_Email, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_LastCall) {
            return this.Update(Original_ContactID, Name, Company, Phone, Email, Client, LastCall, Original_ContactID, Original_Name, Original_Company, Original_Phone, Original_Email, Original_Client, Original_LastCall);
        }
    }
